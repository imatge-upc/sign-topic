    ...
    feats_type: ChoiceEnum([x.name for x in SignFeatsType]) = field(
        ...
        metadata={
            "help": (
                ...
                "keypoints/mediapipe_keypoints/rotational/mediapipe_rotational/i3d/spot_align/spot_align_albert/text/text_albert (default: keypoints)."
            )
        },
    )
...
class SLTopicDetectionTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if SignFeatsType(self.cfg.feats_type) in [
            ...
            SignFeatsType.i3d, SignFeatsType.spot_align_albert, SignFeatsType.text_albert,
        ]:
        ...
        elif SignFeatsType(self.cfg.feats_type) in [SignFeatsType.text, SignFeatsType.spot_align]:
            feats_path = None
        else:
            raise NotImplementedError(
                (
                    'Features other than i3d, keypoints, rotational, spot_align, spot_align_albert, text or text_albert'
        ...
        if SignFeatsType(self.cfg.feats_type) in [SignFeatsType.text, SignFeatsType.spot_align]:
