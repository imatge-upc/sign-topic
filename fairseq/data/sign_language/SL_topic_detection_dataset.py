...
class SLTopicDetectionDataset(FairseqDataset):
    def __init__(
        ...
        if feats_type not in ['video']:
            if feats_type in ['text', 'spot_align']:
    ...
    def __getitem__(self, index):
        ...
        elif self.feats_type in ['text', 'spot_align']:
    ...
    def postprocess(self, feats):
        ...
        elif SignFeatsType[self.feats_type] in [SignFeatsType.text, SignFeatsType.spot_align]:
            pass
        else:
